...
export const Footer = () => {
    return (
        <footer aria-label="Site Footer" className="bg-yellow-100">
            <div className="mx-auto max-w-screen-xl px-4 py-16 sm:px-6 lg:px-8">
                ...
                <div className="grid grid-cols-1 gap-8 lg:grid-cols-3">
                    <div className='m-auto'>
                        ...
                        <p className="mt-4 max-w-xs text-sm text-gray-500 text-center">
                ...
                <p className="mt-8 text-xs text-gray-500">&copy; 2022 Noriega Vera Brandom M.</p>
            </div>
        </footer>
    )
}
