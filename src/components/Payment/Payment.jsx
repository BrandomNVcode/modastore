...
import { orderPayment } from '../../redux/features/order/orderSlice';
...
export const Payment = ({price}) => {
    ...
    return (
        <>
        {
            ...
            <div className='w-full h-full relative top-2 sm:top-6 m-5'>
                <h3 className='text-center font-bold text-lg font-mono text-white bg-black p-4'>
                    Pago completado. Gracias por su compra.
                </h3>
            </div>

            :
            <div className="content-payment min-w-screen min-h-screen flex items-center justify-center px-5 pb-10 pt-16">
                <div className="w-full mx-auto rounded-lg bg-white shadow-lg p-5 text-gray-700">
                    ...
                    <div className="mb-10">
                        <h1 className="text-center font-bold text-xl uppercase">Información segura de pago</h1>
                    </div>

                    <form onSubmit={handlePagar}>
                        <legend className="mb-3 flex -mx-2">
                            <div className="px-2">
                        ...
                        <div className="mb-3">
                            <label className="font-bold text-sm mb-2 ml-1">Nombre en la tarjeta</label>
                            <div>
                                <input
                        ...
                        <div className="mb-10">
                            <label className="font-bold text-sm mb-2 ml-1">Código de seguridad</label>
                            <div>
                                <input
